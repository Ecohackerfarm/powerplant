...
add('Beta vulgaris craca', 'Brassica oleracea var. capitata f. alba', 1);
...
add('Borago officinalis', 'Brassica oleracea var. capitata f. alba', 1);
...
add('Brassica oleracea var. capitata f. alba', 'Tropaeolum majus', 1);
add('Brassica oleracea var. capitata f. alba', 'Phaseolus vulgaris', 1);
add('Brassica oleracea var. capitata f. alba', 'Coriandrum sativum', 1);
add('Brassica oleracea var. capitata f. alba', 'Cucumis sativus', 1);
add('Brassica oleracea var. capitata f. alba', 'Anethum graveolens', 1);
add('Brassica oleracea var. capitata f. alba', 'Calendula officinalis', 1);
add('Brassica oleracea var. capitata f. alba', 'Origanum majorana', 1);
add('Brassica oleracea var. capitata f. alba', 'Helianthus annuus', 1);
add('Brassica oleracea var. capitata f. alba', 'Chamaemelum nobile', 1);
add('Brassica oleracea var. capitata f. alba', 'Allium sativum', 0);
add('Brassica oleracea var. capitata f. alba', 'Lavandula angustifolia', 1);
add('Brassica oleracea var. capitata f. alba', 'Lactuca sativa', 1);
add('Brassica oleracea var. capitata f. alba', 'Mentha spicata', 1);
add('Brassica oleracea var. capitata f. alba', 'Allium cepa', 1);
add('Brassica oleracea var. capitata f. alba', 'Pisum sativum', 1);
add('Brassica oleracea var. capitata f. alba', 'Solanum tuberosum', 1);
add('Brassica oleracea var. capitata f. alba', 'Rosmarinus officinalis', 1);
add('Brassica oleracea var. capitata f. alba', 'Salvia officinalis', 1);
add('Brassica oleracea var. capitata f. alba', 'Tanacetum vulgare', 1);
add('Brassica oleracea var. capitata f. alba', 'Thymus vulgaris', 1);
add('Brassica oleracea var. capitata f. alba', 'Apium graveolens dulce', 1);
add('Brassica oleracea var. capitata f. alba', 'Ruta graveolens', 0);
add('Brassica oleracea var. capitata f. alba', 'Solanum esculentum', 1);
add('Brassica oleracea var. capitata f. alba', 'Fragaria x ananassa', 1);
...
add('Daucus carota subsp. sativus', 'Allium schoenoprasum', 1);
add('Daucus carota subsp. sativus', 'Coriandrum sativum', 1);
add('Daucus carota subsp. sativus', 'Cucumis sativus', 1);
add('Daucus carota subsp. sativus', 'Anethum graveolens', 1);
add('Daucus carota subsp. sativus', 'Malus domestica', 1);
add('Daucus carota subsp. sativus', 'Allium porrum', 1);
add('Daucus carota subsp. sativus', 'Lactuca sativa', 1);
add('Daucus carota subsp. sativus', 'Calendula officinalis', 1);
add('Daucus carota subsp. sativus', 'Origanum majorana', 1);
add('Daucus carota subsp. sativus', 'Allium cepa', 1);
add('Daucus carota subsp. sativus', 'Pastinaca sativa', 0);
add('Daucus carota subsp. sativus', 'Pisum sativum', 1);
add('Daucus carota subsp. sativus', 'Raphanus landra', 1);
add('Daucus carota subsp. sativus', 'Rosmarinus officinalis', 1);
add('Daucus carota subsp. sativus', 'Ruta graveolens', 1);
add('Daucus carota subsp. sativus', 'Salvia officinalis', 1);
add('Daucus carota subsp. sativus', 'Solanum esculentum', 1);
...
add('Rosa sericea', 'Brassica oleracea var. capitata f. alba', 1);
...
add('Vicia faba equina', 'Brassica oleracea var. capitata f. alba', 1);
add('Vicia faba equina', 'Daucus carota subsp. sativus', 1);

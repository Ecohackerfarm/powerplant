...
class CropEditPanel extends React.Component {
  ...
  render() {
    ...
    const initialHerbaceousOrWoody = crop.herbaceousOrWoody
      ? [crop.herbaceousOrWoody]
      : [];
    ...
    const initialSalinity = crop.salinity ? [crop.salinity] : [];
    ...
    const initialSoilWaterRetention = crop.soilWaterRetention
    ...
    return (
      ...
      >
        ...
        <SelectDropdownWithSearch
          ...
          multi={true}
          allowNewItems={true}
          handleChange={this.onTagsChange}
        />
        {[
          this.getSingleDropdownElement(
            'Cutting type',
      ...
      <Form.Group as={Row} controlId={controlId}>
        <Col>
          <Form.Check
            ...
            onChange={event => this.onCheckboxChange(event, property)}
          />
        </Col>
      </Form.Group>
    );
        ...
        <Col>
          <SelectDropdown
            ...
            handleChange={selected =>
              this.onDropdownChange(selected, property, multi)
            }
          />
        </Col>
      </Form.Group>
    ...
    return (
      <Form.Group as={Row} controlId={controlId}>
        ...
        <Col>
          <InputField
            value={crop[property]}
            handleChange={name => handler.bind(this)(name, property)}
          />
        </Col>
      </Form.Group>
    );

		...
		return {
			...
			handle_ident: function(context) {
				...
				return (
					...
					evaluate(context.language.namedIdentRules.follows, function(
						ruleData
					) {
					...
					evaluate(context.language.namedIdentRules.precedes, function(
						ruleData
					) {
						return createProceduralRule(
							context.index + 1,
					...
					evaluate(context.language.namedIdentRules.between, function(
						ruleData
					) {
